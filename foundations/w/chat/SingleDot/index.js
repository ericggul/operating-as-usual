...
export default function SingleDot({ width, height, windowHeight, locationIdx, chatContainerNumber, flash }) {
  //layout related
  ...
  return <S.SingleDot width={width} height={height} x={i * (width + windowHeight * 0.016)} y={j * (height + windowHeight * 0.02)} flash={flash}></S.SingleDot>;
}
